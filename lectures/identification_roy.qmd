...
Using Example @exm-roy_estimation, try setting $\gamma_{3} = 0$ and verify that identification by functional form works in practice: the model can still be estimated using the parametric selection correction.
:::
:::
