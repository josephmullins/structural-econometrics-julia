...
1. Formally, identification refers to *whether* the mapping between model and data can be inverted to a unique parameter (point identification) or set of parameters (partial identification).
2. Informally, identification discussions typically focus on *how* a particular model is identified, which has more to do with the particular estimation strategy than it does with the question of identification.
